...
import 'package:quotes/Screen/quotscreen.dart';
import 'package:sizer/sizer.dart';

import 'Screen/Bieth_Screen.dart';
import 'Screen/Home_Screen.dart';
import 'Screen/Motivation_screen.dart';
import 'Screen/Splsh_Screen.dart';
import 'Screen/failure_screen.dart';
import 'Screen/friend_Screen.dart';
import 'Screen/funny_screen.dart';
import 'Screen/life_Screen.dart';
import 'Screen/love_Screen.dart';
import 'Screen/nature_screen.dart';
    ...
    Sizer(builder: (context, orientation, deviceType) =>  GetMaterialApp(
        theme: ThemeData(
          appBarTheme: AppBarTheme(
            backgroundColor: Color(0xff7D612B),
          ),
          textTheme: TextTheme(
            headline1: TextStyle(
